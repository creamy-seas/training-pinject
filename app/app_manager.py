...
"""
# pylint: disable=W0613,W0611,R0201,R0913,E1101,C0116
import pinject


class AppManager:
    """Main class of the application that exposes all methods that can be called from it"""
    ...
    def run_example_pandas(self):
        dataframe = self._example_pandas_class.create_df()
        self._example_pandas_class.print_df(dataframe)
